# Le Méchoui Abidjan - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Le Méchoui Abidjan**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@lemechouiabidjan.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@lemechouiabidjan.cm` | `user123` | |
...
*   **Contact :** contact@lemechouiabidjan.cm